...
export default class SelectItemsPrompt extends Dialog {
  constructor(items, dialogData={}, options={}) {
    ...
    this.options.classes = ["coldam5e", "dialog", "select-items-prompt", "sheet"];
  ...
  static async create(items, {hint}) {
    ...
    const html = await renderTemplate("systems/coldam5e/templates/apps/select-items-prompt.html", {items, hint});
    return new Promise(resolve => {
      const dlg = new this(items, {
        title: game.i18n.localize("COLDAM5E.SelectItemsPromptTitle"),
        content: html,
        buttons: {
          apply: {
            icon: '<i class="fas fa-user-plus"></i>',
            label: game.i18n.localize("COLDAM5E.Apply"),
            callback: html => {
          ...
          cancel: {
            ...
            label: game.i18n.localize("COLDAM5E.Skip"),
            callback: () => resolve([])
          }
        },
        default: "apply",
