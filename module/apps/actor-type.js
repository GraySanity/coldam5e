...
export default class ActorTypeConfig extends FormApplication {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["coldam5e", "actor-type", "trait-selector"],
      template: "systems/coldam5e/templates/apps/actor-type.html",
      width: 280,
      height: "auto",
      choices: {},
      allowCustom: true,
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("COLDAM5E.CreatureTypeTitle")}: ${this.object.name}`;
  }
  ...
  getData(options) {
    ...
    if ( foundry.utils.getType(attr) !== "Object" ) attr = {
      value: (attr in CONFIG.COLDAM5E.creatureTypes) ? attr : "humanoid",
      subtype: "",
      swarm: "",
      custom: ""
    };
    ...
    // Populate choices
    const types = {};
    for ( let [k, v] of Object.entries(CONFIG.COLDAM5E.creatureTypes) ) {
      types[k] = {
    ...
    return {
      ...
      custom: {
        value: attr.custom,
        label: game.i18n.localize("COLDAM5E.CreatureTypeSelectorCustom"),
        chosen: attr.value === "custom"
      },
      subtype: attr.subtype,
      swarm: attr.swarm,
      sizes: Array.from(Object.entries(CONFIG.COLDAM5E.actorSizes)).reverse().reduce((obj, e) => {
        obj[e[0]] = e[1];
        return obj;
      }, {}),
