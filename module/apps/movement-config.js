...
export default class ActorMovementConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["coldam5e"],
      template: "systems/coldam5e/templates/apps/movement-config.html",
      width: 300,
      height: "auto"
    });
  }
  ...
  /** @override */
  get title() {
    return `${game.i18n.localize("COLDAM5E.MovementConfig")}: ${this.document.name}`;
  }
  ...
  getData(options) {
    ...
    const data = {
      ...
      units: CONFIG.COLDAM5E.movementUnits
    };
