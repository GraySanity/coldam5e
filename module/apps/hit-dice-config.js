...
export default class ActorHitDiceConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["coldam5e", "hd-config", "dialog"],
      template: "systems/coldam5e/templates/apps/hit-dice-config.html",
      width: 360,
      height: "auto"
    });
  }
  ...
  /** @override */
  get title() {
    return `${game.i18n.localize("COLDAM5E.HitDiceConfig")}: ${this.object.name}`;
  }
