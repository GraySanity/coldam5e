...
export default class ActorArmorConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      classes: ["coldam5e", "actor-armor-config"],
      template: "systems/coldam5e/templates/apps/actor-armor.html",
      width: 320,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("COLDAM5E.ArmorConfig")}: ${this.document.name}`;
  }
  ...
  async getData() {
    ...
    return {
      ac: ac,
      calculations: CONFIG.COLDAM5E.armorClasses,
  ...
  async _onChangeInput(event) {
    ...
    const cfg = CONFIG.COLDAM5E.armorClasses[calc];
