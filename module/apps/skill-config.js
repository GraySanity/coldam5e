...
export default class ActorSkillConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["coldam5e"],
      template: "systems/coldam5e/templates/apps/skill-config.html",
      width: 500,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.format("COLDAM5E.SkillConfigureTitle", {skill: CONFIG.COLDAM5E.skills[this._skillId]})}: ${this.document.name}`;
  }
  ...
  getData(options) {
    return {
      ...
      proficiencyLevels: CONFIG.COLDAM5E.proficiencyLevels,
  ...
  _updateObject(event, formData) {
    ...
    if ( !passiveRoll.isDeterministic ) {
      const message = game.i18n.format("COLDAM5E.FormulaCannotContainDiceWarn", {
        name: game.i18n.localize("COLDAM5E.SkillBonusPassive")
      });
