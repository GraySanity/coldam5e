...
export const _getInitiativeFormula = function() {
  ...
  let nd = 1;
  let mods = "";
  if (actor.getFlag("coldam5e", "halflingLucky")) mods += "r1=1";
  if (actor.getFlag("coldam5e", "initiativeAdv")) {
    nd = 2;
    mods += "kh";
  }
  const parts = [
  ...
  const tiebreaker = game.settings.get("coldam5e", "initiativeDexTiebreaker");
