...
export default class ActorSheet5eVehicle extends ActorSheet5e {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["coldam5e", "sheet", "actor", "vehicle"],
      width: 720,
      height: 680
    });
  }
  ...
  _computeEncumbrance(totalWeight, actorData) {
    ...
    totalWeight /= game.settings.get("coldam5e", "metricWeightUnits")
      ? CONFIG.COLDAM5E.encumbrance.vehicleWeightMultiplier.metric
      : CONFIG.COLDAM5E.encumbrance.vehicleWeightMultiplier.imperial;
  ...
  _prepareCrewedItem(item) {
    ...
    item.toggleTitle = game.i18n.localize(`COLDAM5E.${isCrewed ? "Crewed" : "Uncrewed"}`);

    // Handle crew actions
    if (item.type === "feat" && item.data.activation.type === "crew") {
      item.cover = game.i18n.localize(`COLDAM5E.${item.data.cover ? "CoverTotal" : "None"}`);
  ...
  _prepareItems(data) {
    const cargoColumns = [{
      label: game.i18n.localize("COLDAM5E.Quantity"),
      css: "item-qty",
      property: "quantity",
      editable: "Number"
    }];
    ...
    const equipmentColumns = [{
      ...
      label: game.i18n.localize("COLDAM5E.AC"),
      css: "item-ac",
      property: "data.armor.value"
    }, {
      label: game.i18n.localize("COLDAM5E.HP"),
      css: "item-hp",
      property: "data.hp.value",
      editable: "Number"
    }, {
      label: game.i18n.localize("COLDAM5E.Threshold"),
      css: "item-threshold",
      property: "threshold"
    }];
    ...
    const features = {
      actions: {
        label: game.i18n.localize("COLDAM5E.ActionPl"),
        items: [],
        hasActions: true,
        crewable: true,
      ...
      equipment: {
        label: game.i18n.localize("COLDAM5E.ItemTypeEquipment"),
        items: [],
        crewable: true,
      ...
      passive: {
        label: game.i18n.localize("COLDAM5E.Features"),
        items: [],
        dataset: {type: "feat"}
      },
      reactions: {
        label: game.i18n.localize("COLDAM5E.ReactionPl"),
        items: [],
        dataset: {type: "feat", "activation.type": "reaction"}
      },
      weapons: {
        label: game.i18n.localize("COLDAM5E.ItemTypeWeaponPl"),
        items: [],
        crewable: true,
    ...
    const cargo = {
      crew: {
        label: game.i18n.localize("COLDAM5E.VehicleCrew"),
      ...
      passengers: {
        label: game.i18n.localize("COLDAM5E.VehiclePassengers"),
      ...
      cargo: {
        label: game.i18n.localize("COLDAM5E.VehicleCargo"),
        items: [],
        dataset: {type: "loot"},
        columns: [{
          label: game.i18n.localize("COLDAM5E.Quantity"),
          ...
          label: game.i18n.localize("COLDAM5E.Price"),
          css: "item-price",
          property: "data.price",
          editable: "Number"
        }, {
          label: game.i18n.localize("COLDAM5E.Weight"),
          css: "item-weight",
    ...
    for (const item of data.items) {
      ...
      const isCargo = item.flags.coldam5e?.vehicleCargo === true;
      if ( isCargo ) {
  ...
  async _onDropItemCreate(itemData) {
    ...
    foundry.utils.setProperty(itemData, "flags.coldam5e.vehicleCargo", isCargo);
